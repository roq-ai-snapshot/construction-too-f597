...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['logistics-manager', 'owner', 'admin'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Outlet', path: '/outlets', entity: 'outlet', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Rental', path: '/rentals', entity: 'rental', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Tool', path: '/tools', entity: 'tool', service: AccessServiceEnum.PROJECT, icon: FiBox },
